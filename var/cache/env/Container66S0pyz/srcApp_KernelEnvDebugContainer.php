 ...
 */
class srcApp_KernelEnvDebugContainer extends Container
{
    ...
    protected function getDebug_DebugHandlersListenerService()
    {
        ...
        return $this->privates['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, $a, NULL, -1, true, ($this->privates['debug.file_link_formatter'] ?? ($this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL))), true, 'UTF-8');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcApp_KernelEnvDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'srcApp_KernelEnvDebugContainer',
            ...
            'router.cache_class_prefix' => 'srcApp_KernelEnvDebugContainer',
