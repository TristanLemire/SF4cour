...
// Returns the private 'App\Repository\LabelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LabelRepository.php';

return $this->privates['App\\Repository\\LabelRepository'] = new \App\Repository\LabelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
