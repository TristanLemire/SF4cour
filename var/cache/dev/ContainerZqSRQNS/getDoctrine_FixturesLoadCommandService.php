...
include_once $this->targetDirs[3].'/src/DataFixtures/ArtistFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/LabelFixtures.php';
...
include_once $this->targetDirs[3].'/src/DataFixtures/RecordFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ArtistFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\LabelFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\RecordFixtures(), 'groups' => []]]);
