...
// Returns the private 'App\Repository\ArtistRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ArtistRepository.php';

return $this->privates['App\\Repository\\ArtistRepository'] = new \App\Repository\ArtistRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
