...
class Artist extends \App\Entity\Artist implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Artist' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Artist' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Artist' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Artist' . "\0" . 'records'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \App\Entity\Artist
    {
